...
:root {
  ...
  --destructive-foreground: oklch(0.99 0.005 0);
  ...
  --chart-4: oklch(0.62 0.22 27);
  --chart-5: oklch(0.55 0.2 300);
}
...
.dark {
  ...
  --chart-3: oklch(0.78 0.16 75);
  --chart-4: oklch(0.65 0.22 27);
  --chart-5: oklch(0.6 0.2 300);
}

@layer base {
  * { border-color: var(--color-border); }
  body { background-color: var(--color-background); color: var(--color-foreground); font-family: ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, sans-serif; }
  .label-up { text-transform: uppercase; letter-spacing: 0.08em; font-size: 0.7rem; font-weight: 600; color: var(--color-muted-foreground); }
}
